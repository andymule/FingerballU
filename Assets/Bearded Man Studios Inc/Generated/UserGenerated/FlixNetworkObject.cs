...
namespace BeardedManStudios.Forge.Networking.Generated
{
	...
	public partial class FlixNetworkObject : NetworkObject
	{
		...
		public FlixNetworkObject() : base() { Initialize(); }
		public FlixNetworkObject(NetWorker networker, INetworkBehavior networkBehavior = null, int createCode = 0, byte[] metadata = null) : base(networker, networkBehavior, createCode, metadata) { Initialize(); }
		public FlixNetworkObject(NetWorker networker, uint serverId, FrameStream frame) : base(networker, serverId, frame) { Initialize(); }
